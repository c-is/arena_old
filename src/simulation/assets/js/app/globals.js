...
function getSize() {
	...
	if(document.querySelector('.js-get-height')) {document.querySelector('.js-get-height').style.height = windowHeight + 'px'}
}
...
function navigationMenu() {
	...
	let resetMenu = (callback) => {
		TweenLite.to(nav, 0.4, { autoAlpha: 0, x: '100%', onComplete: () => {
